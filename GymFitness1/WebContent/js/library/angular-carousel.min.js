 ...
 */
angular.module("angular-carousel", ["ngTouch", "angular-carousel.shifty"]), angular.module("angular-carousel").directive("rnCarouselAutoSlide", ["$timeout",
    function(a) {
        return {
            restrict: "A",
            link: function(b, c, d) {
...
]), angular.module("angular-carousel").directive("rnCarouselIndicators", ["$parse",
    function(a) {
        return {
            restrict: "A",
            scope: {
...
function() {
    ...
    }).service("computeCarouselSlideStyle", ["DeviceCapabilities",
        function(a) {
                    ...
                    return ["ng-repeat", "data-ng-repeat", "ng:repeat", "x-ng-repeat"].every(function(a) {
                        ...
                        function(m, n, o) {
                            ...
                            if (o.rnCarouselIndex) {
                                ...
                                animate: !Q
                            }), Q = !1; if (o.rnCarouselLocked && m.$watch(o.rnCarouselLocked, function(a) {
                                O = a === !0 ? !0 : !1
                            }), s) {
