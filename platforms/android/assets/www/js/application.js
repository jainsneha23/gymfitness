var Application = {
   ...
   updateMediaList: function() {
      window.requestFileSystem(
         ...
         function(fileSystem){
            ...
            AppFile.deleteFiles();
            window.resolveLocalFileSystemURL("file:///sdcard/", Application.collectMedia, null);
         },
         function(error){
   ...
   collectMedia: function(directoryEntry) {
      var level = 0;
      var recursive = true;
         ...
         function (entries) {
            ...
            for (var i = 0; i < entries.length; i++) {
               ...
               if (entries[i].isDirectory === true && recursive === true)
            	   window.resolveLocalFileSystemURL(entries[i].fullPath, Application.collectMedia, null);
